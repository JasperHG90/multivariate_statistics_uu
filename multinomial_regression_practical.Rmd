...
through successive iterations, much like the Newton-Rhapson algorithm. We, add a penalty term to likelihood so we don't overfit! By increasing the regularization parameter $\lambda$, we 'increase' the minimum cost.
